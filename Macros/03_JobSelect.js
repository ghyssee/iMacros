...
getJobs(jobsObj.districts, selections, !JOBSELECT_LOG, "BestMoneyJobForDistrict1Chapter1To3.csv", JOBSELECT.SORTING.MONEY, JOBSELECT.SORTING.DESCENDING);

selections = [  addFilter(JOBSELECT.SELECTTYPES.EVENT, JOBSELECT.FILTER.NO),
    addFilter(JOBSELECT.SELECTTYPES.MONEYCOST, JOBSELECT.FILTER.NO),
    addFilter(JOBSELECT.SELECTTYPES.EXPRANGE, JOBSELECT.FILTER.YES, 0, 351),
    addFilter(JOBSELECT.SELECTTYPES.CONSUMABLECOST, JOBSELECT.FILTER.NO)
];
