...
selections = [
    ...
    addFilter(JOBSELECT.SELECTTYPES.JOBTYPE, JOBSELECT.FILTER.ENERGY),
    addFilter(JOBSELECT.SELECTTYPES.ENERGYRANGE, JOBSELECT.FILTER.YES, 0, 5000)
];
getJobs(jobsObj.districts, selections, !JOBSELECT_LOG, "Eric_LevelUpJob.csv", JOBSELECT.SORTING.EXP, JOBSELECT.SORTING.DESCENDING);
selections = [
    ...
    addFilter(JOBSELECT.SELECTTYPES.CONSUMABLECOST, JOBSELECT.FILTER.NO),
    addFilter(JOBSELECT.SELECTTYPES.EXPRANGE, JOBSELECT.FILTER.YES, 0, 4000)
];
getJobs(jobsObj.districts, selections, !JOBSELECT_LOG, "Eric_NoLevelUpJob.csv", JOBSELECT.SORTING.MONEY, JOBSELECT.SORTING.DESCENDING);
selections = [
    addFilter(JOBSELECT.SELECTTYPES.EVENT, JOBSELECT.FILTER.NO),
    addFilter(JOBSELECT.SELECTTYPES.MONEYCOST, JOBSELECT.FILTER.NO),
    addFilter(JOBSELECT.SELECTTYPES.JOBTYPE, JOBSELECT.FILTER.ENERGY),
...
getJobs(jobsObj.districts, selections, !JOBSELECT_LOG, "Eric_LowEnergyJobs.csv", JOBSELECT.SORTING.EXP, JOBSELECT.SORTING.DESCENDING);
alert ("done");
